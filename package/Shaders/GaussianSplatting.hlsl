...
/*
SplatData LoadSplatDataTransform(uint idx)
{
    SplatData s = (SplatData) 0;
...
SplatSHData LoadSplatDataSH(uint idx)
{
    SplatSHData s = (SplatSHData) 0;

    // determine formats
    uint scaleFmt = (_SplatFormat >> 8) & 0xFF;
    uint shFormat = (_SplatFormat >> 16) & 0xFF;

    // compute stride of the “other” buffer (rotation + scale + optional SH index)
    uint otherStride = 4; // 4 bytes for the 10.10.10.2 rotation
    if (scaleFmt == VECTOR_FMT_32F)
        otherStride += 12;
    else if (scaleFmt == VECTOR_FMT_16)
        otherStride += 6;
    ...
    // read the per-splat SH index if it was stored in the “other” buffer
    uint otherAddr = idx * otherStride;
    uint shIndex = idx;
    if (shFormat > VECTOR_FMT_6)
        shIndex = LoadUShort(_SplatOther, otherAddr + otherStride - 2);

    // determine how many bytes each SH block takes
    uint shStride;
    if (shFormat == VECTOR_FMT_32F)
        shStride = 192;
    else if (shFormat == VECTOR_FMT_16 || shFormat > VECTOR_FMT_6)
    ...
    // load the first two uint4's of SH coefficients
    uint base = shIndex * shStride;
    uint4 r0 = _SplatSH.Load4(base);
    uint4 r1 = _SplatSH.Load4(base + 16);

    if (shFormat == VECTOR_FMT_32F)
    {
        uint4 r2 = _SplatSH.Load4(base + 32);
        uint4 r3 = _SplatSH.Load4(base + 48);
        uint4 r4 = _SplatSH.Load4(base + 64);
        uint4 r5 = _SplatSH.Load4(base + 80);
        uint4 r6 = _SplatSH.Load4(base + 96);
        uint4 r7 = _SplatSH.Load4(base + 112);
        uint4 r8 = _SplatSH.Load4(base + 128);
        uint4 r9 = _SplatSH.Load4(base + 144);
        uint4 rA = _SplatSH.Load4(base + 160);
        uint rB = _SplatSH.Load(base + 176);

        s.sh1 = half3(asfloat(r0.x), asfloat(r0.y), asfloat(r0.z));
        s.sh2 = half3(asfloat(r0.w), asfloat(r1.x), asfloat(r1.y));
        s.sh3 = half3(asfloat(r1.z), asfloat(r1.w), asfloat(r2.x));
        s.sh4 = half3(asfloat(r2.y), asfloat(r2.z), asfloat(r2.w));
        s.sh5 = half3(asfloat(r3.x), asfloat(r3.y), asfloat(r3.z));
        s.sh6 = half3(asfloat(r3.w), asfloat(r4.x), asfloat(r4.y));
        s.sh7 = half3(asfloat(r4.z), asfloat(r4.w), asfloat(r5.x));
        s.sh8 = half3(asfloat(r5.y), asfloat(r5.z), asfloat(r5.w));
        s.sh9 = half3(asfloat(r6.x), asfloat(r6.y), asfloat(r6.z));
        s.sh10 = half3(asfloat(r6.w), asfloat(r7.x), asfloat(r7.y));
        s.sh11 = half3(asfloat(r7.z), asfloat(r7.w), asfloat(r8.x));
        s.sh12 = half3(asfloat(r8.y), asfloat(r8.z), asfloat(r8.w));
        s.sh13 = half3(asfloat(r9.x), asfloat(r9.y), asfloat(r9.z));
        s.sh14 = half3(asfloat(r9.w), asfloat(rA.x), asfloat(rA.y));
        s.sh15 = half3(asfloat(rA.z), asfloat(rA.w), asfloat(rB));
    }
    else if (shFormat == VECTOR_FMT_16 || shFormat > VECTOR_FMT_6)
    {
        uint4 r2 = _SplatSH.Load4(base + 32);
        uint4 r3 = _SplatSH.Load4(base + 48);
        uint4 r4 = _SplatSH.Load4(base + 64);
        uint3 r5 = _SplatSH.Load3(base + 80);

        s.sh1 = half3(f16tof32(r0.x), f16tof32(r0.x >> 16), f16tof32(r0.y));
        s.sh2 = half3(f16tof32(r0.y >> 16), f16tof32(r0.z), f16tof32(r0.z >> 16));
        s.sh3 = half3(f16tof32(r0.w), f16tof32(r0.w >> 16), f16tof32(r1.x));
        s.sh4 = half3(f16tof32(r1.x >> 16), f16tof32(r1.y), f16tof32(r1.y >> 16));
        s.sh5 = half3(f16tof32(r1.z), f16tof32(r1.z >> 16), f16tof32(r1.w));
        s.sh6 = half3(f16tof32(r1.w >> 16), f16tof32(r2.x), f16tof32(r2.x >> 16));
        s.sh7 = half3(f16tof32(r2.y), f16tof32(r2.y >> 16), f16tof32(r2.z));
        s.sh8 = half3(f16tof32(r2.z >> 16), f16tof32(r2.w), f16tof32(r2.w >> 16));
        s.sh9 = half3(f16tof32(r3.x), f16tof32(r3.x >> 16), f16tof32(r3.y));
        s.sh10 = half3(f16tof32(r3.y >> 16), f16tof32(r3.z), f16tof32(r3.z >> 16));
        s.sh11 = half3(f16tof32(r3.w), f16tof32(r3.w >> 16), f16tof32(r4.x));
        s.sh12 = half3(f16tof32(r4.x >> 16), f16tof32(r4.y), f16tof32(r4.y >> 16));
        s.sh13 = half3(f16tof32(r4.z), f16tof32(r4.z >> 16), f16tof32(r4.w));
        s.sh14 = half3(f16tof32(r4.w >> 16), f16tof32(r5.x), f16tof32(r5.x >> 16));
        s.sh15 = half3(f16tof32(r5.y), f16tof32(r5.y >> 16), f16tof32(r5.z));
    }
    else if (shFormat == VECTOR_FMT_11)
    {
        uint4 r2 = _SplatSH.Load4(base + 32);
        uint3 r3 = _SplatSH.Load3(base + 48);

        s.sh1 = DecodePacked_11_10_11(r0.x);
        s.sh2 = DecodePacked_11_10_11(r0.y);
        s.sh3 = DecodePacked_11_10_11(r0.z);
        s.sh4 = DecodePacked_11_10_11(r0.w);
        s.sh5 = DecodePacked_11_10_11(r1.x);
        s.sh6 = DecodePacked_11_10_11(r1.y);
        s.sh7 = DecodePacked_11_10_11(r1.z);
        s.sh8 = DecodePacked_11_10_11(r1.w);
        s.sh9 = DecodePacked_11_10_11(r2.x);
        s.sh10 = DecodePacked_11_10_11(r2.y);
        s.sh11 = DecodePacked_11_10_11(r2.z);
        s.sh12 = DecodePacked_11_10_11(r2.w);
        s.sh13 = DecodePacked_11_10_11(r3.x);
        s.sh14 = DecodePacked_11_10_11(r3.y);
        s.sh15 = DecodePacked_11_10_11(r3.z);
    }
    else // VECTOR_FMT_6
    {
        s.sh1 = DecodePacked_5_6_5(r0.x);
        s.sh2 = DecodePacked_5_6_5(r0.x >> 16);
        s.sh3 = DecodePacked_5_6_5(r0.y);
        s.sh4 = DecodePacked_5_6_5(r0.y >> 16);
        s.sh5 = DecodePacked_5_6_5(r0.z);
        s.sh6 = DecodePacked_5_6_5(r0.z >> 16);
        s.sh7 = DecodePacked_5_6_5(r0.w);
        s.sh8 = DecodePacked_5_6_5(r0.w >> 16);
        s.sh9 = DecodePacked_5_6_5(r1.x);
        s.sh10 = DecodePacked_5_6_5(r1.x >> 16);
        s.sh11 = DecodePacked_5_6_5(r1.y);
        s.sh12 = DecodePacked_5_6_5(r1.y >> 16);
        s.sh13 = DecodePacked_5_6_5(r1.z);
        s.sh14 = DecodePacked_5_6_5(r1.z >> 16);
        s.sh15 = DecodePacked_5_6_5(r1.w);
    }
