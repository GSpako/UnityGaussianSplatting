...
namespace GaussianSplatting.Runtime
{
    class GaussianSplatRenderSystem
    {
        ...
        internal static readonly ProfilerMarker s_ProfColecTile = new(ProfilerCategory.Render, "GaussianSplat.ColectTile", MarkerFlags.SampleGPU);
        ...
        public Material SortAndRenderSplats(Camera cam, CommandBuffer cmb, RenderTargetIdentifier gaussianRTid)
        {
            ...
            foreach (var kvp in m_ActiveSplats)
            {
                ...
                {
                    gs.currentLine = GaussianSplatRenderer.RenderLine.Culling;
                    SortAndRenderSplatsCulling(gs, mpb, cam, cmb, ref matComposite);
                }
                else
                {
                    gs.currentLine = GaussianSplatRenderer.RenderLine.Base;
                    SortAndRenderSplatsBase(gs, mpb, cam, cmb, ref matComposite);
                }
            }
            return matComposite;
        ...
        public void SortAndRenderSplatsTiles(GaussianSplatRenderer gs, MaterialPropertyBlock mpb, Camera cam, CommandBuffer cmb, RenderTargetIdentifier gaussianRTid, ref Material matComposite)
        {
            ...
            for (int i = 0; i < totalTiles; i += gs.numTiles)
            {
                ...
                gs.ResetCounter(cmb);
                gs.CollectTileSplats(cmb, cam, i);
                cmb.EndSample(s_ProfColecTile);
        ...
        public void SortAndRenderSplatsBase(GaussianSplatRenderer gs, MaterialPropertyBlock mpb, Camera cam, CommandBuffer cmb, ref Material matComposite)
        {
            gs.EnsureMaterials();
            matComposite = gs.m_MatComposite;
            ...
            if (gs.m_FrameCounter % gs.m_SortNthFrame == 0)
                gs.SortPoints(cmb, cam, matrix, true);
            ++gs.m_FrameCounter;
    ...
    public class GaussianSplatRenderer : MonoBehaviour
    {
        ...
        [Tooltip("Grid used in the tile system")]
        ...
        internal GraphicsBuffer m_GpuTile;
        ...
        internal GpuSorting m_Sorter;
        internal GpuSorting.Args m_SorterArgs;
        ...
        public enum RenderLine { Base, Culling, Tiled, CulledTiled }
        public RenderLine currentLine;
        public RenderLine previousLine;
        ...
        internal static class Props
        {
            ...
            public static readonly int SplatTileData = Shader.PropertyToID("_SplatTileData");
            public static readonly int SplatTileDataRO = Shader.PropertyToID("_SplatTileDataReadOnly");
            ...
            public static readonly int SplatCounterRO = Shader.PropertyToID("_SplatCounterRO");
            public static readonly int Quad = Shader.PropertyToID("_Quad");
            ...
            public static readonly int TotalTiles = Shader.PropertyToID("_TotalTiles");
            ...
            public static readonly int UseCulling = Shader.PropertyToID("_UseCulling");
            public static readonly int MinRadius = Shader.PropertyToID("_RMin");
            public static readonly int AlfaMin = Shader.PropertyToID("_AlfaMin");
        }
        ...
        void InitSortBuffers(int count)
        {
            ...
            m_SorterArgs.survivingSplats = m_GpuSplatCounter;
        ...
        void DisposeResourcesForAsset()
        {
            ...
            DisposeBuffer(ref m_GpuSplatCounter);
            DisposeBuffer(ref m_GpuSplatTileCounter);
        ...
        internal void CopyCounterToDrawArgs(CommandBuffer cmb)
        {
            ...
            cmb.DispatchCompute(m_CSSplatUtilities, (int)KernelIndices.CopyCounterToDrawArgs, 1, 1, 1);
        }
        ...
        internal void CalcViewDataCulled(CommandBuffer cmb, Camera cam)
        {
            ...
            cmb.SetComputeBufferParam(m_CSSplatUtilities, (int)KernelIndices.CalcViewDataCulled, Props.VisibleSplatSortKeys, m_GpuSortKeys);
            cmb.SetComputeBufferParam(m_CSSplatUtilities, (int)KernelIndices.CalcViewDataCulled, Props.VisibleSplatSortDistances, m_GpuSortDistances);
            cmb.SetComputeBufferParam(m_CSSplatUtilities, (int)KernelIndices.CalcViewDataCulled, Props.SplatCounter, m_GpuSplatCounter);
        ...
        internal void CalcAllViewDataTiled(CommandBuffer cmb, Camera cam)
        {
            if (cam.cameraType == CameraType.Preview)
                return;
            ...
            cmb.SetComputeBufferParam(m_CSSplatUtilities, (int)KernelIndices.CalcViewDataAllTiled, Props.SplatDistances, m_GpuSortDistances);

            cmb.SetComputeBufferParam(m_CSSplatUtilities, (int)KernelIndices.CalcViewDataAllTiled, Props.SplatCounter, m_GpuSplatCounter);
            cmb.SetComputeBufferParam(m_CSSplatUtilities, (int)KernelIndices.CalcViewDataAllTiled, Props.SplatTileCounter, m_GpuSplatTileCounter);

            cmb.SetComputeBufferParam(m_CSSplatUtilities, (int)KernelIndices.CalcViewDataAllTiled, Props.SplatTileData, m_GpuTile);
            ...
            m_CSSplatUtilities.GetKernelThreadGroupSizes((int)KernelIndices.CalcViewDataAllTiled, out uint gsX, out _, out _);
            cmb.DispatchCompute(m_CSSplatUtilities, (int)KernelIndices.CalcViewDataAllTiled, (m_GpuView.count + (int)gsX - 1) / (int)gsX, 1, 1);
        }

        internal void CalcViewDataTiled(CommandBuffer cmb, Camera cam)
        {
            if (cam.cameraType == CameraType.Preview)
                return;
            ...
            // calculate view dependent data for each splat
            SetAssetDataOnCS(cmb, KernelIndices.CalcViewDataTiled);
            ...
            m_CSSplatUtilities.GetKernelThreadGroupSizes((int)KernelIndices.CalcViewDataTiled, out uint gsX, out _, out _);
            cmb.DispatchCompute(m_CSSplatUtilities, (int)KernelIndices.CalcViewDataTiled, (m_GpuView.count + (int)gsX - 1) / (int)gsX, 1, 1);
        }

        internal void CollectTileSplats(CommandBuffer cmb, Camera cam, int index)
        {
            ...
            cmb.SetComputeBufferParam(m_CSSplatUtilities, (int)KernelIndices.CollectTileSplats, Props.SplatTileCounter, m_GpuSplatTileCounter);

            cmb.SetComputeIntParam(m_CSSplatUtilities, Props.StartTile, index);
            cmb.SetComputeIntParam(m_CSSplatUtilities, Props.NumTiles, numTiles);
            cmb.SetComputeIntParam(m_CSSplatUtilities, Props.TilesCountX, Mathf.FloorToInt(gridSize.x));
            cmb.SetComputeIntParam(m_CSSplatUtilities, Props.TilesCountY, Mathf.FloorToInt(gridSize.y));
            ...
            cmb.DispatchCompute(m_CSSplatUtilities, (int)KernelIndices.CollectTileSplats, (m_GpuView.count + (int)gsX - 1) / (int)gsX, numTiles, 1);
        }
        ...
        internal void RenderTileSplats(CommandBuffer cmb, Camera cam, int tileIndex, RenderTargetIdentifier gaussianRTid)
        {
            ...
            cmb.SetComputeIntParam(cs, Props.StartTile, tileIndex);
            cmb.SetComputeIntParam(cs, Props.NumTiles, numTiles);
        ...
        public void EditSetSplatCount(int newSplatCount)
        {
            ...
            var newGpuView = new GraphicsBuffer(GraphicsBuffer.Target.Structured, newSplatCount, kGpuViewDataSize) { name = "Gpu_View" };
            var newGpuTile = new GraphicsBuffer(GraphicsBuffer.Target.Structured, newSplatCount, kGpuTileDataSize) { name = "Gpu_Tile" };
